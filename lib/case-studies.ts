...
export const CASES: Record<CaseSlug, CaseStudy> = {
  ...
  barakah: {
    ...
    tagline: 'A podcast built on the butterfly effect the small acts of goodness that ripple out into waves of change given a mark that reads as ripple, sound wave and mic all at once.',
    sector: 'MEDIA / PODCAST', scope: 'STRATEGY / IDENTITY / WEBSITE',
    year: '2022',
    brief: 'A new podcast about the compounding power of small, sincere actions needed a brand system where the mark itself carried the idea before a single word was spoken.',
    problemHead: 'A BIG IDEA THAT NEEDED A MARK, NOT A LOGO.',
    problemBody: 'The Barakah Effect had the conversations already, hosts, guests and a growing back-catalogue. What it did not have was a visual identity that made the concept legible on a thumbnail, a mic sticker or a merch drop. In a crowded feed of Islamic-media brands leaning on ornamental calligraphy or clip-art crescents, the show needed a mark that said what the show was about at a glance.',
    digBody: 'We started with the name. "The Barakah Effect" is a play on the butterfly effect: a small act of good, done sincerely, compounds into something disproportionately large. That was the show’s whole thesis, and it deserved to be the whole brand thesis too. The visual system had to carry cause and effect in one form: something you drop into a still surface that turns into something much larger.',
    insight: 'Barakah is a ripple. Draw the ripple.',
    leapHead: 'ONE MARK. THREE READINGS. RIPPLE, SOUND WAVE, MIC.',
    leapBody: 'We built the identity around a single concentric-ripple form the visual grammar of a drop hitting water, waves radiating outwards. Depending on where you meet it, the same mark reads as three different things at once: a ripple (the butterfly-effect concept), a sound wave (the podcast form), and the head of a microphone (the medium). One shape doing the work of three metaphors.',
    solutionBody: 'A concentric-ripple monogram paired with a confident editorial wordmark, a warm-dark colour system for the on-air studio look, and a modular website that leads with the show and its guests. The ripple carries the brand across podcast art, mic wraps, merch and web without ever needing to explain itself.',
    payoff: 'A brand system that scaled from a mic sticker to a launch website and merch drop without breaking a single mark carrying the concept, the medium and the cause of the show in one shape.',
  ...
  revivers: {
    ...
    tagline: 'A youth-led movement reviving the message of Islam given a mark strong enough to rally a tribe around it.',
    sector: 'FAITH / YOUTH MOVEMENT', scope: 'IDENTITY',
    year: '2022',
    brief: 'A young community building a movement around monotheism and the legacy of the Prophet Muhammad (peace be upon him) needed an identity as bold as the message they carry.',
    problemHead: 'A GENERATION-WIDE MESSAGE WITH NO BANNER TO STAND UNDER.',
    problemBody: 'Revivers exists to spread the core message of tawheed and revive the legacy of the Prophet ﷺ. The community was growing but had no visual identity that carried the weight of what they stood for, or that a young person could wear, share or rally behind.',
    digBody: 'We spent time with the founders and early tribe. Two ideas kept surfacing: the youth are the torch-bearers of this message, and revival is an act, not a slogan. Everything the mark did had to be verb-shaped.',
    insight: 'The youth are the torch-bearers make the mark the torch.',
    leapHead: 'A FIST FOR THE POWER. A FLAME FOR THE MESSAGE.',
    leapBody: 'We combined a raised fist the emblem of a generation ready to change something with a flame carrying the light of the message. One symbol for two ideas: the power the youth can bring, and the truth they carry into the world.',
    solutionBody: 'A single icon that reads instantly on a t-shirt, a poster, a phone screen or a poster in a masjid, paired with a wordmark confident enough to lead a movement.',
    payoff: 'A brand a tribe wanted to wear a mark young Muslims could ascribe themselves to, unifying people around one goal and one mission.',
    heroImg: R('A:652044929f0ed92a4213149e_Revivers.png'),
    gallery: [
      g({ img: '639d6fc988734f053019191b_Group%20368.png',  alt: 'Revivers primary mark',     col: '1 / -1', tag: '[ FIG.01 ]', caption: 'PRIMARY MARK' }),
      g({ img: '639d71bd9835780912d9f545_Rectangle%20138.png', alt: 'Revivers brand identity system', col: 'auto', tag: '[ FIG.02 ]', caption: 'IDENTITY SYSTEM' }),
      g({ img: '639d71c53c2d5884a16ae7a8_Rectangle%20136.png', alt: 'Revivers visual application',    col: 'auto', tag: '[ FIG.03 ]', caption: 'APPLICATION' }),
      g({ img: '639d71cde553bffe2f8725f8_Rectangle%2060.png',  alt: 'Revivers brand collateral',      col: '1 / -1', tag: '[ FIG.04 ]', caption: 'COLLATERAL' }),
      g({ img: '639d71f73c2d5849d56ae823_Group%204045.png',    alt: 'Revivers mark exploration',      col: 'auto', tag: '[ FIG.05 ]', caption: 'MARK EXPLORATION' }),
      g({ img: '639d71faa44941c1429297f1_Group%20881.png',     alt: 'Revivers brand pattern',         col: 'auto', tag: '[ FIG.06 ]', caption: 'PATTERN' }),
      g({ img: '638c52e7c4293470ee8cb073_T-shirt.png',         alt: 'Revivers t-shirt',               col: '1 / -1', tag: '[ FIG.07 ]', caption: 'MERCH // T-SHIRT' })
    ]
  },
  grainer: {
    caseLabel: '[ CASE_FILE: GRAINER // STRATEGY, IDENTITY & WEB ]',
    title: 'GRAINER.', client: 'GRAINER',
    tagline: 'A rebrand that repositioned Grainer as Southeast Asia’s premier FinTech & PropTech partner and unlocked a step-change in valuation.',
    sector: 'FINTECH / PROPTECH', scope: 'STRATEGY / IDENTITY / WEBSITE',
    year: '2022',
    brief: 'A serious FinTech and PropTech player was still wearing a startup coat. We rebuilt the brand to match the ambition and the investor conversations that came with it.',
    problemHead: 'A PLATFORM READY TO SCALE. A BRAND STILL PLAYING SMALL.',
    problemBody: 'Grainer was already delivering serious FinTech and PropTech infrastructure across Southeast Asia. But the brand read like a scrappy startup: undifferentiated in a category full of blue-and-corporate lookalikes, and doing none of the trust-building work the sales and fundraising conversations needed.',
    digBody: 'A deep discovery process with the leadership and target enterprise buyers surfaced two truths. First, the category defaults to cold, faceless corporate. Second, enterprise buyers still buy from people. The brand had to be sophisticated and human at once.',
    insight: 'In a category of faceless corporates, humanity is the differentiator.',
    leapHead: 'A CRYPTIC "G" FOR THE TECH. FACES FOR THE HUMANITY.',
    leapBody: 'A logomark built from a cryptic formation of the letter G a seed for innovation gave Grainer a mark serious enough to earn a place on an investor deck. Then we cut against category convention with a set of personal avatars built from the team’s own facial features, so every touchpoint had a person in it.',
    solutionBody: 'A confident wordmark and monogram, a warm-professional colour system, editorial typography and a personal avatar library that runs across the website, decks and business cards.',
    payoff: 'The rebrand helped Grainer win the trust of investors and clients an impressive step-change in valuation followed the launch.',
    heroImg: R('A:652044925790a4fb129a08d4_Grainer.png'),
    gallery: [
      g({ img: '638c532a85632561bbf1562d_Logo.png',            alt: 'Grainer logo',            col: '1 / -1', tag: '[ FIG.01 ]', caption: 'LOGO SYSTEM' }),
      g({ img: '639d6daf66f4163198f40b0f_Grainer%20Logo.png',  alt: 'Grainer wordmark',        col: 'auto',   tag: '[ FIG.02 ]', caption: 'WORDMARK' }),
      g({ img: '638c533fc429344ec18cb7ac_Pattern.png',         alt: 'Grainer pattern',         col: 'auto',   tag: '[ FIG.03 ]', caption: 'PATTERN' }),
      g({ img: '638c533c9bf138cec9ded3b5_Business%20Card.png', alt: 'Grainer business card',   col: 'auto',   tag: '[ FIG.04 ]', caption: 'BUSINESS CARD' }),
      g({ img: '638c534640a98462d8e3561d_Tshirt.png',          alt: 'Grainer t-shirt',         col: 'auto',   tag: '[ FIG.05 ]', caption: 'MERCH // T-SHIRT' }),
      g({ img: '638c5343698caa6548513ae0_Mockups.png',         alt: 'Grainer brand mockups',   col: '1 / -1', tag: '[ FIG.06 ]', caption: 'BRAND MOCKUPS' }),
      g({ img: '638c534a40a984e131e35635_Laptop.png',          alt: 'Grainer website',         col: '1 / -1', tag: '[ FIG.07 ]', caption: 'WEB' })
    ]
  },
  sifa: {
    caseLabel: '[ CASE_FILE: SIFA // BRAND IDENTITY ]',
    title: 'SIFA.', client: 'SIFA',
    tagline: 'Brand identity for a healthcare-tech platform bridging hospitals and patients built around a motherly, unmistakably human warmth.',
    sector: 'HEALTHTECH', scope: 'IDENTITY',
    year: '2022',
    brief: 'A serious healthcare platform for Indonesia needed to feel warm and trustworthy without turning into another antiseptic health-tech logo.',
    problemHead: 'HEALTHCARE-TECH BRANDS ALL FEEL COLD. SIFA COULDN’T.',
    problemBody: 'Sifa bridges the gap between hospitals and patients using new technology. But the audience they serve especially in rural Indonesia does not choose healthcare based on tech; they choose based on trust. The category defaults sterile blues and clinical iconography would have worked against the mission.',
    digBody: 'We explored every way to represent the brand caring, empathic, technological, spiritual. One direction kept resonating with the founders and the audience they described: a motherly, central-figure nature that expresses being present for the community.',
    insight: 'Trust in healthcare is not clinical it is motherly.',
    leapHead: 'A LOGO WITH A HEART, A PRAYER, A BOOK AND A SUNRISE.',
    leapBody: 'The Sifa mark carries multiple abstract meanings layered into a single soft-edged form: a person praying, an open scripture, a rising sun, a heart. Each connects with a spiritually oriented Indonesian audience without ever being on-the-nose.',
    solutionBody: 'A soft-edged wordmark and icon system, a warm human colour palette and a set of applications that carry the brand from an app screen to a hospital billboard.',
    payoff: 'A healthcare brand that feels like a family member instead of a facility making healthcare accessible especially for people in rural areas Sifa is built to serve.',
    heroImg: R('A:6520467bda7ce6152907d889_Sifa.png'),
    gallery: [
      g({ img: '639d726e38e93f4e73de5eca_Group%20952.png',  alt: 'Sifa primary mark',           col: '1 / -1', tag: '[ FIG.01 ]', caption: 'PRIMARY MARK' }),
      g({ img: '638c53df6a8a277b8a9e309c_Doctor.png',       alt: 'Sifa applied to a doctor',    col: 'auto',   tag: '[ FIG.02 ]', caption: 'IN CONTEXT' }),
      g({ img: '638c53dd346ec7a49f8afa5b_Building.png',     alt: 'Sifa building signage',       col: 'auto',   tag: '[ FIG.03 ]', caption: 'SIGNAGE' }),
      g({ img: '638c53e1c239decb63c3286d_Mockups.png',      alt: 'Sifa brand mockups',          col: '1 / -1', tag: '[ FIG.04 ]', caption: 'BRAND MOCKUPS' }),
      g({ img: '638c53e79d4abb9477071330_App.png',          alt: 'Sifa app',                    col: 'auto',   tag: '[ FIG.05 ]', caption: 'APP' }),
      g({ img: '638c53e44c238b1b7fb21133_Billboard.png',    alt: 'Sifa billboard',              col: 'auto',   tag: '[ FIG.06 ]', caption: 'BILLBOARD' }),
      g({ img: '638c53ce10a6ce81905bd619_Laptop.png',       alt: 'Sifa website',                col: '1 / -1', tag: '[ FIG.07 ]', caption: 'WEB' })
    ]
  },
  quraany: {
    caseLabel: '[ CASE_FILE: QURAANY // STRATEGY & IDENTITY ]',
    title: 'QURAANY.', client: 'QURAANY',
    tagline: 'A social enterprise making the Qur’an accessible to communities worldwide named and marked around one personal idea: My Qur’an.',
    sector: 'SOCIAL ENTERPRISE / QUR’AN ACCESSIBILITY', scope: 'STRATEGY / IDENTITY',
    year: '2022',
    brief: 'A distribution non-profit needed a brand that was personal, not institutional so every donor and every recipient could feel a direct stake in the mission.',
    problemHead: 'A HUGE MISSION THAT KEPT SOUNDING INSTITUTIONAL.',
    problemBody: 'Quraany distributes and localises the Qur’an for communities across the world. But the category conservative Islamic non-profits tends to speak in institutional language, which flattens what is meant to be one of the most personal relationships in a Muslim’s life.',
    digBody: 'We audited how similar organisations name and mark themselves and how their donors and recipients actually described the impact. The word people kept returning to was mine my copy, my community, my Qur’an.',
    insight: 'A copy of the Qur’an belongs to someone. Make the brand belong to them too.',
    leapHead: 'NAME IT "MY QUR’AN". MARK IT WITH BOTH LANGUAGES.',
    leapBody: 'Quraany means my Qur’an in Arabic. We used that idea as the whole brand: a name that belongs to whoever holds it, and a mark that fuses the English Q with the Arabic ق (qaaf) so it reads to both audiences at once.',
    solutionBody: 'A wordmark and monogram built on the Q / ق fusion, with subtle negative-space patterns inside the Q that echo classical Quranic manuscript design carrying the mark into books, sajadahs, cards and campaign visuals.',
    payoff: 'A brand disruptive enough to break the institutional default and personal enough to make every touchpoint feel like it was made for the person holding it.',
    heroImg: R('A:65204492f65a3ac72cee89e0_Quraany.png'),
    gallery: [
      g({ img: '638c5055c239de372ac2ffd8_Logo%202.png',        alt: 'Quraany primary logo',   col: '1 / -1', tag: '[ FIG.01 ]', caption: 'PRIMARY MARK' }),
      g({ img: '639d69339835787d7dd98bbb_Quraany%20Logo.png',  alt: 'Quraany wordmark',       col: 'auto',   tag: '[ FIG.02 ]', caption: 'WORDMARK' }),
      g({ img: '638c506eb9a23c49efce68f1_Logos.png',           alt: 'Quraany logo system',    col: 'auto',   tag: '[ FIG.03 ]', caption: 'LOGO SYSTEM' }),
      g({ img: '638c50820787c74527de9c0f_Book.png',            alt: 'Quraany applied to book',col: 'auto',   tag: '[ FIG.04 ]', caption: 'BOOK' }),
      g({ img: '638c507f40a984f72ee34360_Card.png',            alt: 'Quraany card',           col: 'auto',   tag: '[ FIG.05 ]', caption: 'CARD' }),
      g({ img: '638c506557859fadb6d87a47_Sajadah.png',         alt: 'Quraany sajadah',        col: '1 / -1', tag: '[ FIG.06 ]', caption: 'SAJADAH' }),
      g({ img: '638c507765a7e46a3178583d_Mockups.png',         alt: 'Quraany brand mockups',  col: '1 / -1', tag: '[ FIG.07 ]', caption: 'BRAND MOCKUPS' })
    ]
  }
};

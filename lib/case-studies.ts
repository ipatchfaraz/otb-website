...
export const CASES: Record<CaseSlug, CaseStudy> = {
  ...
  barakah: {
    ...
    tagline: 'Brand strategy, identity & website for a podcast unpacking how faith, work and daily life multiply into barakah.',
    sector: 'MEDIA / PODCAST', scope: 'STRATEGY / IDENTITY / WEBSITE',
    year: '2022',
    brief: 'A new podcast needed a brand that could carry a big idea across audio, on-screen, on-air and on-body without diluting the message.',
    problemHead: 'A PODCAST WITH A BIG IDEA AND NO PLACE TO LIVE.',
    problemBody: 'The Barakah Effect had the conversations already, hosts, guests and a growing back-catalogue. What it did not have was a brand identity that made it feel like more than another Islamic content channel: a show visitors could recognise from a thumbnail, a mic sticker or a merch drop.',
    digBody: 'We stress-tested every Islamic-media brand adjacent to the show. Most leaned on ornamental calligraphy or heavy Islamic tropes; almost none felt confident, editorial and modern at the same time. The gap was clear: The Barakah Effect could own confident-modern for a young Muslim audience that already lives in podcasts and short-form video.',
    insight: 'Barakah is invisible until you name it and the brand had to feel like the naming.',
    leapHead: 'BUILD A MEDIA BRAND, NOT A CONTENT CHANNEL.',
    leapBody: 'We treated The Barakah Effect like a network property: a wordmark strong enough to sit on a mic, a merch tag, a website hero and a YouTube thumbnail without a redesign. Every touchpoint reinforced the show, not the episode.',
    solutionBody: 'A confident, editorial wordmark paired with a compact monogram, a warm dark colour system for the on-air studio look, and a modular website that leads with the show and its guests, not decoration.',
    payoff: 'A brand system that scaled from a mic sticker to a launch website and merch drop without breaking, giving the show a recognisable frame for every episode.',
